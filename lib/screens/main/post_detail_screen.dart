          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                if (post.tags.isNotEmpty) ...[
                  ...
                  Wrap(
                    ...
                    children: post.tags.map((tag) => Container(
                      ...
                      decoration: BoxDecoration(
                        color: AppTheme.softGreen, borderRadius: BorderRadius.circular(20)),
                  ...
                  ClipRRect(
                    ...
                    child: Image.network(post.imageUrl!, fit: BoxFit.cover,
                        errorBuilder: (_, __, ___) => Container(
                          height: 160, color: AppTheme.softGreen,
                  ...
                  children: [
                    GestureDetector(
                      ...
                      child: Row(
                        children: [
                          Icon(
                            post.isLikedBy(uid) ? Icons.favorite : Icons.favorite_border,
                            color: post.isLikedBy(uid) ? Colors.red : AppTheme.textMid,
                            size: 20,
                          ),
                          const SizedBox(width: 6),
                          Text('${post.likeCount} likes', style: TextStyle(
                    ...
                    Row(children: [
                      ...
                      const SizedBox(width: 6),
                      Text('${post.commentCount} comments', style: const TextStyle(
                ...
                // DISCUSSION header
                const Text('Discussion', style: TextStyle(
                    fontSize: 16, fontWeight: FontWeight.w800, color: AppTheme.textDark)),
                const SizedBox(height: 14),

                // Comments stream
                StreamBuilder<List<CommentModel>>(
                  stream: context.read<CommunityProvider>().commentsStream(post.id),
                  builder: (context, snapshot) {
                    ...
                    if (comments.isEmpty) {
                      return const Padding(
                        ...
                        child: Center(
                          child: Text('Be the first to comment!', style: TextStyle(
        ...
        children: [
          CircleAvatar(
            ...
            backgroundImage: c.userPhotoUrl != null
                ? NetworkImage(c.userPhotoUrl!) : null,
          ...
          Expanded(
            child: Container(
              ...
              decoration: BoxDecoration(
                color: AppTheme.bgGreen, borderRadius: BorderRadius.circular(12)),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Row(
                    children: [
                      Text(c.userName, style: const TextStyle(
                          fontWeight: FontWeight.w700, fontSize: 13, color: AppTheme.textDark)),
                      const Spacer(),
                      Text(_timeAgo(c.createdAt), style: const TextStyle(
                          fontSize: 10, color: AppTheme.textLight)),
                    ],
                  ),
                  const SizedBox(height: 4),
                  Text(c.content, style: const TextStyle(
