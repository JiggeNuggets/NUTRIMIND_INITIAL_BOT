                                ...
                                (i) => Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color: AppTheme.primaryGreen
                                            .withValues(alpha: 0.3 + (i % 4) * 0.08),
                                        borderRadius: BorderRadius.circular(10),
                                      ),
                                      child: Icon(
                                        [Icons.eco, Icons.restaurant, Icons.local_florist, Icons.grain][i % 4],
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                            gradient: LinearGradient(
                              ...
                              colors: [Colors.transparent, AppTheme.darkGreen.withValues(alpha: 0.9)],
                            ),
                          ),
                        ),
                      ),
                      ...
                      Positioned(
                        ...
                        child: Row(
                          children: [
                            ...
                            const Text('NutriMind', style: TextStyle(
                    ...
                    child: Column(
                      ...
                      children: [
                        RichText(
                          text: const TextSpan(
                            style: TextStyle(
                              ...
                              color: AppTheme.textDark, letterSpacing: -0.8, height: 1.2,
                            ),
                            children: [
                        ...
                        const Text(
                          ...
                          style: TextStyle(color: AppTheme.textMid, fontSize: 13, height: 1.55),
                        ),
                        // Avoid Spacer() flex overflow on smaller web viewports.
                        const SizedBox(height: 12),
                        // Google Sign In
                        ElevatedButton.icon(
                          onPressed: auth.loading ? null : () => _handleGoogle(context),
                          icon: auth.loading
                              ? const SizedBox(
                                  width: 18, height: 18,
