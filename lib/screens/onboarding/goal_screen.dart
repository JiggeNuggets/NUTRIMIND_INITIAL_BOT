      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: List.generate(4, (i) => Expanded(
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: i == 0 ? AppTheme.primaryGreen : AppTheme.divider,
            ...
            const Text('Step 1 of 3', style: TextStyle(fontSize: 11,
                color: AppTheme.textLight, fontWeight: FontWeight.w500)),
            const SizedBox(height: 24),

            const Text('What is your goal?', style: TextStyle(
            ...
            ElevatedButton(
              onPressed: _selectedGoal != null
                  ? () {
                      context.read<AuthProvider>().updateOnboarding(
                        goal: _selectedGoal!,
                        gender: 'Male',
                        height: 168,
                        weight: 64,
                      ...
                      Navigator.push(context,
                          MaterialPageRoute(builder: (_) => BiometricsScreen(goal: _selectedGoal!)));
                    }
                  : null,
          ...
          children: [
            ...
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(goal['title'] as String, style: const TextStyle(
