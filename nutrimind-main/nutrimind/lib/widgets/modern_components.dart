  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow:
            isDisabled ? ModernAppTheme.shadowNone : ModernAppTheme.shadowMd,
      ),
      child: Material(
        ...
        child: InkWell(
          ...
          child: Center(
            child: Row(
              ...
              children: [
                if (iconData != null) ...[
                  Icon(iconData, color: ModernAppTheme.primaryGreen, size: 18),
                  const SizedBox(width: 8),
                ],
                Text(
                  label,
            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  ...
                  Column(
                    children: [
                      if (!widget.isLogged && widget.onLog != null)
                        GestureDetector(
                          onTap: widget.onLog,
                          child: Container(
                            padding: const EdgeInsets.symmetric(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          _MacroDisplay(
                            value: widget.carbs.toString(),
                            label: 'Carbs',
                            color: ModernAppTheme.warning,
                          ),
                          _MacroDisplay(
                            value: widget.fat.toString(),
                            label: 'Fat',
                            color: ModernAppTheme.error,
                          ),
                        ],
                      ),
                      const SizedBox(height: 14),
                            ...
                            Expanded(
                              child: GestureDetector(
                                ...
                                child: Container(
                                  height: 48,
                                  decoration: BoxDecoration(
                                    color: ModernAppTheme.error.withValues(
                                      alpha: 0.1,
                                    ),
                                    borderRadius: BorderRadius.circular(
                                      ModernAppTheme.radiusMd,
                                    ),
                                    border: Border.all(
                                      color: ModernAppTheme.error,
                                      width: 1,
...
class NutritionSummaryCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final gradient = ModernAppTheme.getBmiGradient(bmiCategory);
