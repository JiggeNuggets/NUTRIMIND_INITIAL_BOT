...
class MealPlannerPrompts {
  ...
  static const String prePromptSnack =
      "I've got a basket full of snack ingredients, and I want a light, budget-friendly bite. Your mission: create a snack using most of these items and give it a catchy name. Keep it practical for a Filipino/Davao day. Here's the list of snack items:";

  static const String preSnack =
      "For snack, imagine a simple creation called 'Market Merienda Cup' with fruit, protein, and just enough sweetness to keep energy steady. Now, craft a practical snack idea from the list provided.";
  ...
  static String userContentSnack({
    required String userName,
    required List<String> items,
  }) =>
      '${MealPlannerPrompts.prePromptSnack} $items '
      '${MealPlannerPrompts.exampleResponse(userName)} '
      '${MealPlannerPrompts.preSnack} '
      '${MealPlannerPrompts.negativePrompt}';
}
